...
const Home = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const homePage = await api.get("/pages/home");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await api.patch("/pages/home", homePageData);
            toast.success("Saved!");
    ...
    return (
        <DefaultLayout>
            ...
            <div className="mx-auto max-w-270">
                <h1 className="text-3xl font-bold mb-4 dark:text-white">Home page</h1>
                {error && <p className="text-red-600">{error}</p>}

                <div className="grid grid-cols-3 lg:grid-cols-5 gap-8">
                    {/* Title on Left */}
                    <div
                        className="col-span-3 p-7 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <div
                        ...
                        <div className="flex flex-col items-center p-7 sticky top-[100px]  rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center justify-center space-y-3">
                                    ...
                                    <p className="mt-1.5">Supported: MP4</p>
                                </div>
                            </div>
                        </div>
