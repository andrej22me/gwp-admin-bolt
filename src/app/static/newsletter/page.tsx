...
const EditPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const contactPage = await api.get("/pages/newsletter");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.patch("/pages/newsletter", contactPageData); // Adjust the endpoint as per your backend
      toast.success("Saved!")
  ...
  return (
      <DefaultLayout>
        ...
        <div className="mx-auto max-w-270">
          <h1 className="text-3xl font-bold mb-4 dark:text-white">Newsletter</h1>
