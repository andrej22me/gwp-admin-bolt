...
const EditPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const aboutPage = await api.get("/pages/about");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await api.patch("/pages/about", aboutPageData);
            toast.success("Saved!");
    ...
    return (
        <DefaultLayout>
            ...
            <div className="mx-auto max-w-270">
                <h1 className="text-3xl font-bold mb-4 dark:text-white">About page</h1>
