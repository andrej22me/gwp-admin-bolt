...
const EditPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const contactPage = await api.get("/pages/contact");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.patch("/pages/contact", contactPageData); // Adjust the endpoint as per your backend
      toast.success("Saved!", {})
    } catch (err: any) {
  ...
  return (
      <DefaultLayout>
        ...
        <div className="mx-auto max-w-270">
          <h1 className="text-3xl font-bold mb-4 dark:text-white">Contact page</h1>
